...
announce("smoke_test_level25_skills", host, port)
...
out = cmd(warrior, f"switchopponents l25dummy2", 1.5)
...
out = cmd(thief, f"subterfuge l25dummy4", 1.5)
...
announce_done("smoke_test_level25_skills", host, port)
