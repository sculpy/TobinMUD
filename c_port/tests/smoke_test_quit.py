...
announce("smoke_test_quit", host, port)
...
send_line(s2, "1"); recv_all(s2)  # territory: urban
send_line(s2, "1"); recv_all(s2)  # class: mage
send_line(s2, "done")
recv_all(s2)
send_line(s2, "done"); recv_all(s2)  # alignment: neutral
...
s2.close()
announce_done("smoke_test_quit", host, port)
