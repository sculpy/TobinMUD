...
## User batch 2026-08-08 (continued) -- logged, working these now

- [ ] Add a  command: settable timer in seconds, level 59+ immortal only.
- [ ] Add a  argument to both  and  for immediate execution (bypassing/overriding any pending timer).
